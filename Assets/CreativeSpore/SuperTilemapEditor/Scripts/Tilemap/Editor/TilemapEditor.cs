...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public partial class TilemapEditor : Editor
    {
        ...
        {
            Paint,
            //Color, //disable until next version
            Renderer,
            Map,
            Collider,
        }
        ...
        private void OnInspectorGUI_Renderer()
        {
            ...
            */
            ...
            if(GUILayout.Button("Export To Png"))
            {
                ...
                {
                    AtlasEditorWindow.MakeTextureReadable(m_tilemap.Tileset.AtlasTexture);
                    Texture2D tilemapText = TilemapUtils.CreateTexture2DFromTilemap(m_tilemap);
